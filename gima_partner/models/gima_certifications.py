...
class GimaCertifications(models.Model):
    ...
    type = fields.Selection([('fgas_individual_licence', 'F-GAS Individual Licence'), ('fgas_company_licence', 'F-GAS Company Licence'),
                             ('9001_company_licence', 'Company Certification 9001')],
                            required=True, string="Type Certification")
